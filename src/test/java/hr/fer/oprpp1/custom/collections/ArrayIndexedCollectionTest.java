...
public class ArrayIndexedCollectionTest {
	private ArrayIndexedCollection withElementsCollection = new ArrayIndexedCollection();
	private ArrayIndexedCollection cleanCollection = new ArrayIndexedCollection();
	...
	@AfterEach
	void cleanUp() {
		cleanCollection = new ArrayIndexedCollection();
	}
	...
	@Test
	public void testConstructorFillElementsFromOtherCollectionInvalidInitialCapacity() {
		ArrayIndexedCollection dummyCollection = new ArrayIndexedCollection(withElementsCollection, -5);
		assertArrayEquals(dummyCollection.toArray(), withElementsCollection.toArray());
	}
